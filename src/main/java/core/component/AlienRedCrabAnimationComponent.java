...
public class AlienRedCrabAnimationComponent implements Component, Serializable {
        ...
        private static transient Image idle_1, idle_2, idle_3, idle_4, idle_5, idle_6, idle_7, idle_8, idle_9, idle_10,
                        ...
                        idle_21, idle_22, idle_23, idle_24, idle_25, idle_26, idle_27, idle_28, idle_29, idle_30,
                        idle_31, idle_32;
        ...
        public void init(Entity actor) {
                ...
                try {
                        ...
                        idle_1 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle1.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_2 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle2.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_3 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle3.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_4 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle4.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_5 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle5.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_6 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle6.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_7 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle7.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_8 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle8.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_9 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle9.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_10 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle10.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_11 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle11.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_12 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle12.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_13 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle13.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_14 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle14.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_15 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle15.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_16 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle16.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_17 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle17.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_18 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle18.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_19 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle19.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_20 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle20.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_21 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle21.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_22 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle22.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_23 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle23.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_24 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle24.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_25 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle25.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_26 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle26.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_27 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle27.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_28 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle28.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_29 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle29.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_30 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle30.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_31 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle31.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        idle_32 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/idle32.png").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);

                        attack_1 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/attack1").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        attack_2 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/attack2").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        attack_3 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/attack3").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        attack_4 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/attack4").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        attack_5 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/attack5").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        attack_6 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/attack6").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        attack_7 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/attack7").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                        attack_8 = new Image(
                                        new File("resources/assets/Enemy/alien_crab_red/attack8").toURI().toString(),
                                        ACTOR_WIDTH, ACTOR_HEIGHT, false, true);
                } catch (Exception e) {
                        e.printStackTrace();
                }
