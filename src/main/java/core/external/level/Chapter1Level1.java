...
public class Chapter1Level1 extends GameMap {
	...
	public Chapter1Level1() {
		...
		EndPoint ep = new EndPoint(1200, 850, 100, 175, "src/main/resources/assets/Door.png");
		Grass block1 = new Grass(500.0, 900.0, 100, 100, "src/main/resources/assets/Grass.png");
