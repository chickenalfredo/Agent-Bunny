...
<<<<<<< HEAD
		monster.addComponents(new PhysicsComponent(), new AttackComponent(), new RenderComponent(monster, "src/main/resources/assets/Beetle.png"), new HealthComponent(), new AIComponent(monster), new CollidableComponent(), new WeaponComponent(sword2));
		
		Enemy wolf = new Enemy(200.0, 300.0, (screenWidth * 0.035), (screenHeight * 0.063));
		wolf.addComponents(new PhysicsComponent(), new AttackComponent(), new RenderComponent(wolf, "src/main/resources/assets/Cyclops.png"), new HealthComponent(), new AIComponent(wolf), new CollidableComponent(), new WeaponComponent(sword3));
=======
...
>>>>>>> e7fb1988c244fac8167391a51ad5f6c3124d1321
