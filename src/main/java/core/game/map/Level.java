...
public class Level extends GameMap implements Serializable {
	...
	public Level() {
        ...
        hero.addAttribute(new TypeAttribute(TypeAttribute.Type.HERO), new CollidableAttribute(true), new NameAttribute("Hero"));
        sprites.add(hero);
        ...
        alienBug.addAttribute(new TypeAttribute(TypeAttribute.Type.ENEMY), new CollidableAttribute(true), new NameAttribute(""));
        ...
        alienCrabPurple.addAttribute(new TypeAttribute(TypeAttribute.Type.ENEMY), new CollidableAttribute(true), new NameAttribute(""));
        ...
        alienCrabRed.addAttribute(new TypeAttribute(TypeAttribute.Type.ENEMY), new CollidableAttribute(true), new NameAttribute(""));
        ...
        alienDragon.addAttribute(new TypeAttribute(TypeAttribute.Type.ENEMY), new CollidableAttribute(true), new NameAttribute(""));
        ...
        alienTentacle.addAttribute(new TypeAttribute(TypeAttribute.Type.ENEMY), new CollidableAttribute(true), new NameAttribute(""));
        ...
        blob.addAttribute(new TypeAttribute(TypeAttribute.Type.ENEMY), new CollidableAttribute(true), new NameAttribute(""));
        sprites.add(blob);
        ...
        blueBug.addAttribute(new TypeAttribute(TypeAttribute.Type.ENEMY), new CollidableAttribute(true), new NameAttribute(""));
        sprites.add(blueBug);
        ...
        greenBug.addAttribute(new TypeAttribute(TypeAttribute.Type.ENEMY), new CollidableAttribute(true), new NameAttribute(""));
        ...
        orangeBug.addAttribute(new TypeAttribute(TypeAttribute.Type.ENEMY), new CollidableAttribute(true), new NameAttribute(""));
        ...
        purpleBug.addAttribute(new TypeAttribute(TypeAttribute.Type.ENEMY), new CollidableAttribute(true), new NameAttribute(""));
        ...
        fatty.addAttribute(new TypeAttribute(TypeAttribute.Type.ENEMY), new CollidableAttribute(true), new NameAttribute(""));
        sprites.add(fatty);
        ...
        endPoint.addAttribute(new TypeAttribute(TypeAttribute.Type.STATIC_OBJECT), new CollidableAttribute(true), new NameAttribute(""));
        ...
        checkPoint.addAttribute(new TypeAttribute(TypeAttribute.Type.STATIC_OBJECT), new CollidableAttribute(true), new NameAttribute(""));
        ...
        block1.addAttribute(new TypeAttribute(TypeAttribute.Type.STATIC_OBJECT), new CollidableAttribute(true), new NameAttribute(""));
        sprites.add(block1);
        ...
        block2.addAttribute(new TypeAttribute(TypeAttribute.Type.STATIC_OBJECT), new CollidableAttribute(true), new NameAttribute(""));
        sprites.add(block2);
        ...
        block3.addAttribute(new TypeAttribute(TypeAttribute.Type.STATIC_OBJECT), new CollidableAttribute(true), new NameAttribute(""));
        sprites.add(block3);
        ...
        block4.addAttribute(new TypeAttribute(TypeAttribute.Type.STATIC_OBJECT), new CollidableAttribute(true), new NameAttribute(""));
        sprites.add(block4);
		...
		for (int i = 0; i < screenWidth * 3; i += (screenWidth * 0.035)) {
            ...
            wall.addAttribute(new TypeAttribute(TypeAttribute.Type.STATIC_OBJECT), new CollidableAttribute(true), new NameAttribute("wall"));
